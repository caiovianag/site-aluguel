...
import SwiperComponent12 from '../components/Swiper12';
...
export default function Detail() {
 return (
   <View style={styles.container}>
    ...
    Excelente casa, arquitetura moderna, localizada em rua privativa, com 120m² de área construída, 3 suítes, 3 vagas de garagem, sala ampla, cozinha, wc social, nascente, piso porcelanato.
    15 min da Av. Corrêa Lima    </Text>

    <ScrollView horizontal showsHorizontalScrollIndicator={false} style={{paddingHorizontal: 15, marginTop: 35}}>
      <View style={styles.slide}>
        <Image
        source={require('../assets/r24.jpg')}
