 ...
 return (
   <View style={styles.container}>
    ...
    <View style={styles.headerContent}>
      <View style={{ width: '65%' }}>
        <Text style={styles.house}>Apartamento Meireles</Text>
      </View>
    ...
    Apartamento com vista mar, em localização privilegiada no Meireles, a 50m da Avenida Beira Mar de Fortaleza.
    ...
    <ScrollView horizontal showsHorizontalScrollIndicator={false} style={{paddingHorizontal: 15, marginTop: 35}}>
      <View style={styles.slide}>
        <Image
        source={require('../assets/novidades14.jpg')}
      ...
      <View style={styles.slide}>
        <Image
        source={require('../assets/novidades15.jpg')}
        style={{width: 90, height: 90, borderRadius: 8}}
        />
      </View>
      ...
      <View style={styles.slide}>
        <Image
        source={require('../assets/novidades16.jpg')}
        style={{width: 90, height: 90, borderRadius: 8}}
        />
      </View>
    </ScrollView>
