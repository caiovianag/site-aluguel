 ...
 return (
   <View style={styles.container}>
    ...
    <View style={styles.headerContent}>
      <View style={{ width: '65%' }}>
        <Text style={styles.house}>Apartamento Mucuripe</Text>
      </View>
    ...
    Lindo apartamento no bairro Mucuripe, todo mobiliado, mobília nova...
    ...
    <ScrollView horizontal showsHorizontalScrollIndicator={false} style={{paddingHorizontal: 15, marginTop: 35}}>
      <View style={styles.slide}>
        <Image
        source={require('../assets/novidades34.jpg')}
      ...
      <View style={styles.slide}>
        <Image
        source={require('../assets/novidades35.jpg')}
        style={{width: 90, height: 90, borderRadius: 8}}
        />
      </View>
      ...
      <View style={styles.slide}>
        <Image
        source={require('../assets/novidades36.jpg')}
        style={{width: 90, height: 90, borderRadius: 8}}
        />
      </View>
    </ScrollView>
