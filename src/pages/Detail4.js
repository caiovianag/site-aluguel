 ...
 return (
   <View style={styles.container}>
    ...
    <View style={styles.headerContent}>
      <View style={{ width: '65%' }}>
        <Text style={styles.house}>Casa Lagoa Redonda</Text>
      </View>
    ...
    Linda casa em condomínio, ampla, arejada, iluminada e mobiliada. A casa conta com uma sala ampla no piso inferior e ainda cozinha com móveis fixos instalados, lavabo, quintal, dependência completa, área de serviço e 02 vagas de garagem.
    ...
    <ScrollView horizontal showsHorizontalScrollIndicator={false} style={{paddingHorizontal: 15, marginTop: 35}}>
      <View style={styles.slide}>
        <Image
        source={require('../assets/mais14.jpg')}
      ...
      <View style={styles.slide}>
        <Image
        source={require('../assets/mais15.jpg')}
        style={{width: 90, height: 90, borderRadius: 8}}
        />
      </View>
      ...
      <View style={styles.slide}>
        <Image
        source={require('../assets/mais16.jpg')}
        style={{width: 90, height: 90, borderRadius: 8}}
        />
      </View>
