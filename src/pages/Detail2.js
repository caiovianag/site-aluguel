 ...
 return (
   <View style={styles.container}>
    ...
    <View style={styles.headerContent}>
      <View style={{ width: '65%' }}>
        <Text style={styles.house}>Casa Fortaleza</Text>
      </View>
    ...
    O apartamento está localizado no Bairro Aldeota, proximo ao Aterro!!
    </Text>

    <ScrollView horizontal showsHorizontalScrollIndicator={false} style={{paddingHorizontal: 15, marginTop: 35}}>
      <View style={styles.slide}>
        <Image
        source={require('../assets/novidades24.jpg')}
      ...
      <View style={styles.slide}>
        <Image
        source={require('../assets/novidades25.jpg')}
        style={{width: 90, height: 90, borderRadius: 8}}
        />
      </View>
      ...
      <View style={styles.slide}>
        <Image
        source={require('../assets/novidades26.jpg')}
        style={{width: 90, height: 90, borderRadius: 8}}
        />
      </View>
    </ScrollView>
